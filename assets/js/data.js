...
export const services = [
    ...
    },
    {
        ...
        description: 'Если объем небольшой или вам удобнее привезти сырье самостоятельно, заранее согласуйте приезд.',
...
export const serviceConditions = [
    ...
    },
    {
        ...
        text: 'Картон, пленка, тара и упаковочные отходы можно вывозить по накоплению или по согласованному графику.',
...
// Equipment timeline
export const equipmentTimeline = [
    {
        number: '1',
...
export const faqs = [
    {
        ...
        answer: 'Да, вывоз возможен по согласованию. Обычно ориентируются на объем от 100 кг в городе, но итоговая цена зависит от адреса, типа материала и доступности площадки.'
    },
    {
        question: 'Какие материалы принимаются?',
        answer: 'Макулатура, картон, стеклобой, отдельные виды пластика, металл, бытовая техника, компьютеры, лампы и другие отходы по согласованию.'
    },
    {
        question: 'Почему цена не фиксированная для всех?',
        answer: 'Стоимость зависит от рынка, объема, загрязненности, сортировки, расстояния и необходимости предоставить документы. Обычно расчет делается после осмотра на месте.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Да, желательно. Бумагу, пластик, стекло, металл и технику лучше держать отдельно. Это ускоряет оценку и может улучшить условия приема.'
    },
    {
        question: 'Берете ли мокрую макулатуру?',
        answer: 'Мокрая или сильно загрязненная макулатура может приниматься по сниженной стоимости или не приниматься вообще, в зависимости от степени повреждения.'
    },
    {
        question: 'Работаете ли вы с юридическими лицами?',
        answer: 'Да. Для организаций доступны договоры, акты, реквизиты, регулярный вывоз и согласование документов согласно законодательству.'
    },
    {
        question: 'Можно ли вывезти технику из офиса?',
        answer: 'Да, офисную технику и компьютеры можно согласовать отдельно. Важно назвать количество, состояние, наличие крупногабаритных предметов.'
    },
    {
        question: 'Что делать с лампами?',
        answer: 'Лампы относятся к специальным отходам. Не смешивайте их с обычным мусором или вторсырьем, храните отдельно и согласуйте прием заранее.'
    },
    {
        question: 'Как быстрее получить расчет?',
        answer: 'Подготовьте фото, примерный вес или объем, адрес, описание доступа к площадке и желаемую дату вывоза. Это поможет менеджеру быстрее дать ориентировочную цену.'
    }
];
